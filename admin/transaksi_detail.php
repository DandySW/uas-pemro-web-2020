				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-12">
							...
							<span class="pull-right">Tanggal Transaksi: <strong><?php echo date("F d, Y", strtotime($srow['transaksi_date'])); ?></strong></span>
						</div>
					</div>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td><?php echo number_format($pdrow['harga'], 2); ?></td>
